...
class Expressiveness extends Question {	
	...
	public function answers(){
		...
		$lua7 = parent::luaSays("Again: Lua has no syntactical sugar for XML serialization. But since the typing system is extremely simpe, it's very easy to write a generic method who can serialize any type of table. An example of a library who serializes tables is TinyXml. Since Lua has a very simple way to represent data, most features can be implemented in a very generic way. Lua doesn't has much built-in expressiveness, but gives tools to programmers to make the language expressive in the way they want.");
