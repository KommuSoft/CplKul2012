...
class Expressiveness extends Question {	
	...
	public function answers(){
		...
		$cpp0 = parent::cppSays("I agree with Lua. The syntactical sugar of LINQ is very nice, but it doesn't yield that much gain. C++ has for instance template metaprogramming. It is a powerfull mechanism to generalize code and reduces the amount of code significantly.");
		...
		$cpp0 = parent::cppSays("Template metaprogramming goes beyond generic classes. You can do some nice things with generic classes but template programming is turing complete.");
		...
		$cSharp1 = parent::cSharpSays("C# has a similar feature: the fact that you are working with a coroutine doesn't has to be specified. One simply uses the yield statement in order to emit an element of the list.");
