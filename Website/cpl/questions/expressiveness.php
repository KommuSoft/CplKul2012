...
class Expressiveness extends Question {	
	...
	*/
	...
	public function answers(){
		...
		$lua2 = parent::luaSays("Coroutines are methods that work in a collaborative fashion with the main program. They have their own stack and local variables, but are used for instance for data manipulation. One can think of the like threads. However coroutines work sequentially.");
