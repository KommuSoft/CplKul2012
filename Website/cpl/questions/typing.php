...
print(type(x[1])) -- output: number";
		...
		return $lua0.$cpp0.$cSharp0.$lua1.$cpp1.$cSharp1.$lua2.$python0.$lua3.$cSharp2.$lua4.$cpp2.$lua5.$java0.$lua6;
	}
