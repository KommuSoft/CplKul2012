...
[Willem: De hele game wereld werkt met C++, is dit statement betrouwbaar?]");
		...
		$cSharp = parent::cSharpSays("C# and Mono: C# aims to be a broad language: for both scientific and business purposes. Therefore it implements most of features that can be found in other languages (even constructions who are considered harmfull like the goto statement). C# has a variaty of constructions and systems so users can write code witch code included in another language including Lua" . parent::bib()->cite(3) .".");
