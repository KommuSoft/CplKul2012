...
//Prototype-based programming is a style of object-oriented programming in which classes are not present, and behavior reuse (known as inheritance in class-based languages) is performed via a process of cloning existing objects that serve as prototypes. This model can also be known as classless, prototype-oriented or instance-based programming. Delegation is the language feature that supports prototype-based programming.
		...
		$cpp0 = parent::cppSays("I see that the notation is adapted to be more familiar for users who have experience with classes in object-oriented languages. Can you explain how those tables can be used to emulate classes?");		
		...
		$lua6 = parent::luaSays("First, I want to mention that this is just an approach. There are other possible approaches, for example to provide multiple inheritance".parent::bib()->cite(22).". The main design for objects offers no privacy mechanisms. This is a reflection of some of the basic design decisions behind Lua. The aim of Lua is at building small to medium programs where just a few programmers work on. For this reason, Lua wants to avoid such redundancy. But again, there are ways to implement the privacy mechanism. If we judge based on simplicity, performance and flexibility, the approach using the \"__index\" is probably the best".parent::bib()->cite(22).".");
