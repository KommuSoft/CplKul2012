...
class LanguageDesign extends Question {	
	...
	public function answers(){
		...
		$lua6 = parent::luaSays("Lua wasn't intended to become a glue language. However LucasArts created a game and used Lua as a scripting engine. Therefore Lua got a lot of attention from the gaming industry. Probably it's generic and dynamic design were keyfeatures for it's succes.");
