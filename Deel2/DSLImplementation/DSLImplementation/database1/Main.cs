...
public class Test
{
	...
	public static void Main (string[] args)
	{
		...
		println (fr.fetchFlight(new Country("The Netherlands"), new Country("Belgium"), startDateTime: new DateTime(year: 2012, month: 1, day: 16)));
		println (fr.fetchFlight(new City("amsterdam"), new City("charleroi"), startDateTime: new DateTime(year: 2012, month: 1, day: 16)));
